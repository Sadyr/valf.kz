...
<head>
    ...
    <link rel="stylesheet" href="css/bootstrap.min.cssm">
...
"  style="width: 40%;" alt="<?php the_title();?>" >
...
<div class=" container container-2 container-main">
    <img   class="item-main img"  src="<?php echo  (get_template_directory_uri()) . '/assets/img/main-digifexDuo.webp' ?>"> 
    <h2 class="h2-main ">ГЕРМЕТИЧНЫЙ КОТЕЛ AIRFEL DIGIFIX DUO    </h2>
...
<br>
<br>        Герметичный конденсационный котел Airfel Digifel Condense является идеальным вариантом для тех, что стремится к экономичным решениям при сохранении качества, безопасности и экономии топлива.
    </p>
</div>
...
<img   class="item-improve img"  src= <?php echo(get_template_directory_uri()) . '/assets/img/digifixduoImprove.webp' ?> style="width: 50%;" alt="Digifix Duo" >
</div>
...
<div class="container container-2 container-red-icon  ">
   ...
   <div class="items-red  fa-lg" ><div class="item-red-icon"><i class="fa-solid fa-layer-group"></i></div><h6>Изготовлено в Турции</h6></div>
     ...
     <img   class="item-control img"  src= <?php echo(get_template_directory_uri()) . '/assets/img/woman.webp'?>  style="width: 50%;" alt="Digifix Duo" >
     </div>
